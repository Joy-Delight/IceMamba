...
This project is based on Mamba ([paper](https://arxiv.org/abs/2312.00752)), VMamba ([paper](https://arxiv.org/abs/2401.10166), [code](https://github.com/MzeroMiko/VMamba)), Swin-Transformer ([paper](https://arxiv.org/pdf/2103.14030.pdf), [code](https://github.com/microsoft/Swin-Transformer)), and PatchTST ([code](https://github.com/yuqinie98/PatchTST)).
